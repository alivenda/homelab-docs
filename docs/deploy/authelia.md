...
See [Deploying an App](index.md) for the per-app HTTPRoute + `ExtensionRef` wiring. Commit all manifests to `homelab-manifests/apps/authelia/` and let ArgoCD sync.
