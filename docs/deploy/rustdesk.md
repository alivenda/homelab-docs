...
| **Runs on** | k3s (cluster) — LoadBalancer service through MetalLB |
...
## Deploy hbbs and hbbr { #step-1-deploy-hbbs-and-hbbr }
...
## Retrieve the public key { #step-3-retrieve-the-public-key }
...
## Configure RustDesk clients { #step-4-configure-rustdesk-clients }
...
4. Set **Key** to the public key from [Retrieve the public key](#step-3-retrieve-the-public-key).
