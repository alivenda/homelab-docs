...
1. The cluster nodes are already on Tailscale (from Network). The MetalLB IP `10.0.20.50` is on the Lab VLAN which is advertised via the Tailscale subnet router.
