...
tier from the [Storage & Data Architecture](../concepts/storage.md) — the cluster runs app
...
write-heavy — the [decomposition rule](../concepts/storage.md#how-to-decompose-one-app)
is the tie-breaker.
